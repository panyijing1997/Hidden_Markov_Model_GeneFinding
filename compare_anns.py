...
if __name__ == '__main__':
    ...
    '''
    # Read true annotation
    true_ann1 = read_ann("data/true-ann1.fa")
    true_ann2 = read_ann("data/true-ann2.fa")
    true_ann3 = read_ann("data/true-ann3.fa")
    true_ann4 = read_ann("data/true-ann4.fa")
    true_ann5 = read_ann("data/true-ann5.fa")
